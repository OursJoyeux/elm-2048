...
var _user$project$Grid$randomValue = function (p) {
	return A2(
		_elm_lang$core$Random$map,
		function (val) {
			return (_elm_lang$core$Native_Utils.cmp(val, p) < 0) ? 2 : 4;
		},
...
var _user$project$Grid$rows = function (grid) {
	return A2(
		...
		A2(
			...
			F2(
				function (t1, t2) {
					return _elm_lang$core$Native_Utils.eq(t1.pos.y, t2.pos.y);
				}),
			A2(
				_elm_lang$core$List$sortBy,
				function (_p7) {
	...
	function (pos, grid) {
		return A2(
			...
			A2(
				...
				function (t) {
					return _elm_lang$core$Native_Utils.eq(t.pos, pos);
				},
				_user$project$Grid$tiles(grid)));
	});
...
var _user$project$Grid$size = function (grid) {
	return _user$project$Grid$width(grid) * _user$project$Grid$height(grid);
};
var _user$project$Grid$Tile = F2(
	function (a, b) {
		return {pos: a, val: b};
	});
...
var _user$project$Grid$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Grid$availablePositions = function (grid) {
	var occupied = A2(
		_elm_lang$core$List$map,
		function (_) {
			return _.pos;
	...
	var all = A3(
		...
		A2(
			_elm_lang$core$List$range,
			0,
			_user$project$Grid$height(grid) - 1));
	return A2(
		_elm_lang$core$List$filter,
		function (pos) {
			return !A2(_elm_lang$core$List$member, pos, occupied);
		},
		all);
};
var _user$project$Grid$randomPosition = function (grid) {
	var avail = _user$project$Grid$availablePositions(grid);
	return A2(
		_elm_lang$core$Random$map,
		function (pos) {
			return A2(_elm_community$list_extra$List_Extra$getAt, pos, avail);
		},
		A2(
			_elm_lang$core$Random$int,
			0,
			_elm_lang$core$List$length(avail) - 1));
};
var _user$project$Grid$generator = function (grid) {
	var makeTile = F2(
		function (pos, val) {
			return A2(
				_elm_lang$core$Maybe$map,
	...
	return A3(
		_elm_lang$core$Random$map2,
		makeTile,
		_user$project$Grid$randomPosition(grid),
		_user$project$Grid$randomValue(0.8));
};
var _user$project$Grid$generate = F2(
	function (msg, grid) {
		return A2(
			_elm_lang$core$Random$generate,
			msg,
			_user$project$Grid$generator(grid));
	});
var _user$project$Grid$Grid = function (a) {
	return {ctor: 'Grid', _0: a};
};
var _user$project$Grid$make = function (dim) {
		...
		if (_p10.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Just(
				_user$project$Grid$Grid(
					{
						dim: _user$project$Grid$dim(grid),
						tiles: {
							ctor: '::',
							_0: {pos: pos, val: val},
							_1: _user$project$Grid$tiles(grid)
						}
					}));
		} else {
			return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Grid$init = function (grid) {
	var genAndSet = function (grid) {
		return A2(
			_elm_lang$core$Random$map,
			_elm_lang$core$Maybe$andThen(
				function (tile) {
					return A3(_user$project$Grid$set, tile.pos, tile.val, grid);
				}),
			_user$project$Grid$generator(grid));
	};
	return A2(
		_elm_lang$core$Random$map,
		_elm_lang$core$Maybe$withDefault(grid),
		A2(
			...
			function (_p11) {
				return A2(
					...
					A2(_elm_lang$core$Maybe$map, genAndSet, _p11));
			},
			genAndSet(grid)));
};
var _user$project$Grid$apply = F2(
	function (moves, grid) {
		var getNewTile = function (move) {
			var _p12 = move;
			switch (_p12.ctor) {
				case 'Keep':
					return _p12._0;
		...
		return _user$project$Grid$Grid(
			{
				dim: _user$project$Grid$dim(grid),
				tiles: A2(_elm_lang$core$List$map, getNewTile, moves)
			});
	});
...
var _user$project$Grid$Merge = F3(
	function (a, b, c) {
		return {ctor: 'Merge', _0: a, _1: b, _2: c};
	});
var _user$project$Grid$Move = F2(
	function (a, b) {
		return {ctor: 'Move', _0: a, _1: b};
	});
var _user$project$Grid$Keep = function (a) {
	return {ctor: 'Keep', _0: a};
};
var _user$project$Grid$lineMoves = F3(
	function (factory, acc, tiles) {
		lineMoves:
		while (true) {
			var makeMerge = F3(
				function (acc, t1, t2) {
					...
					return A3(
						_user$project$Grid$Merge,
						t1,
						t2,
						{pos: newPos, val: t1.val + t2.val});
				});
			var makeMove = F2(
				function (acc, tile) {
					var newPos = A2(
						...
						tile.pos,
						_elm_lang$core$List$length(acc));
					return _elm_lang$core$Native_Utils.eq(newPos, tile.pos) ? _user$project$Grid$Keep(tile) : A2(
						_user$project$Grid$Move,
						tile,
						_elm_lang$core$Native_Utils.update(
							tile,
							{pos: newPos}));
			...
			if (_p13.ctor === '[]') {
				...
				if (_p13._1.ctor === '[]') {
					...
					var _p15 = _p13._1._0;
					var _p14 = _p13._0;
					if (_elm_lang$core$Native_Utils.eq(_p14.val, _p15.val)) {
						var _v7 = factory,
							_v8 = {
							ctor: '::',
							_0: A3(makeMerge, acc, _p14, _p15),
							_1: acc
						},
							_v9 = _p16;
						factory = _v7;
						...
						var _v10 = factory,
							_v11 = {
							ctor: '::',
							_0: A2(makeMove, acc, _p14),
							_1: acc
						},
							_v12 = {ctor: '::', _0: _p15, _1: _p16};
						factory = _v10;
						acc = _v11;
						tiles = _v12;
						continue lineMoves;
...
var _user$project$Grid$moves = F2(
	function (dir, grid) {
		var makePosColRev = F2(
			function (old, index) {
				return {
					x: old.x,
					y: (_user$project$Grid$height(grid) - index) - 1
				};
			});
		var makePosCol = F2(
			function (old, index) {
				return {x: old.x, y: index};
			});
		var makePosRowRev = F2(
			function (old, index) {
				return {
					x: (_user$project$Grid$width(grid) - index) - 1,
					y: old.y
				};
			});
		var makePosRow = F2(
...
var _user$project$Grid$move = F2(
	function (dir, grid) {
		return A2(
			_user$project$Grid$apply,
			A2(_user$project$Grid$moves, dir, grid),
			grid);
	});
...
var _user$project$View$viewTiles = function (grid) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$View$viewTile,
		_user$project$Grid$tiles(grid));
};
...
var _user$project$View$viewCellRows = F2(
	function (width, row) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$View$viewCell(row),
			A2(_elm_lang$core$List$range, 0, width - 1));
	});
var _user$project$View$viewCells = F2(
	function (width, height) {
		return _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$map,
				_user$project$View$viewCellRows(width),
				A2(_elm_lang$core$List$range, 0, height - 1)));
	});
var _user$project$View$viewGrid = function (grid) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				A2(
					...
					A2(
						...
						A2(
							...
							'-',
							_elm_lang$core$Basics$toString(
								_user$project$Grid$height(grid)))))),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_user$project$View$viewCells,
				_user$project$Grid$width(grid),
				_user$project$Grid$height(grid)),
			_user$project$View$viewTiles(grid)));
};
...
var _user$project$Main$codeToDirection = function (code) {
	...
	switch (_p0) {
		case 37:
			return _elm_lang$core$Maybe$Just(_user$project$Grid$Left);
		case 38:
			return _elm_lang$core$Maybe$Just(_user$project$Grid$Up);
		case 39:
			return _elm_lang$core$Maybe$Just(_user$project$Grid$Right);
		case 40:
			return _elm_lang$core$Maybe$Just(_user$project$Grid$Down);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
...
var _user$project$Main$NewTile = function (a) {
	return {ctor: 'NewTile', _0: a};
};
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								grid: A2(
									_elm_lang$core$Maybe$withDefault,
									model.grid,
									A3(_user$project$Grid$set, _p1._0._0.pos, _p1._0._0.val, model.grid))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$Main$InitGrid = function (a) {
	return {ctor: 'InitGrid', _0: a};
};
var _user$project$Main$init = function () {
	var grid = _user$project$Grid$make(
		{w: 4, h: 4});
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Main$Model, 0, grid),
		_1: A2(
			_elm_lang$core$Random$generate,
			_user$project$Main$InitGrid,
			_user$project$Grid$init(grid))
	};
}();
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Grid.Grid":{"args":[],"tags":{"Grid":["{ dim : Grid.Dimension, tiles : List Grid.Tile }"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"NewGame":[],"NewTile":["Maybe.Maybe Grid.Tile"],"InitGrid":["Grid.Grid"],"KeyDown":["Keyboard.KeyCode"]}}},"aliases":{"Grid.Value":{"args":[],"type":"Int"},"Keyboard.KeyCode":{"args":[],"type":"Int"},"Grid.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Grid.Tile":{"args":[],"type":"{ pos : Grid.Position, val : Grid.Value }"},"Grid.Dimension":{"args":[],"type":"{ w : Int, h : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
